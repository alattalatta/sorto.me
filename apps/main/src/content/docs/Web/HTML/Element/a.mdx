...
<LiveExample height={120} name="demo" />
...
링크와 같은 대화형 요소는 상호작용하기에 충분한 크기의 활성화 영역을 가져야 합니다. 운동조절 장애를 가진 사용자와, 터치 스크린처럼 정확하지 않은 입력 도구 사용자롤 포함해 다양한 사람을 도울 수 있습니다. 최소 [44x44](https://www.w3.org/TR/WCAG21/#dfn-css-pixels) CSS 픽셀을 권장합니다.
