...
**`hwb()`** 함수형 표기는 [sRGB](https://ko.wikipedia.org/wiki/SRGB) 색을 색상(_hue_), 백색(_whiteness_), 흑색(_blackness_) 성분으로 표현합니다. 선택적으로 알파 성분이 색의 투명도를 나타냅니다.
