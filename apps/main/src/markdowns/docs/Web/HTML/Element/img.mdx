...
- : `height`
  - 이미지의 [내재된 높이][내재적 크기]를 직접 지정합니다. CSS 픽셀 단위이며, 단위 없는 정수 값을 지정해야 합니다.
- : `ismap`
...
- : `width`
  - 이미지의 [내재된 너비][내재적 크기]를 직접 설정합니다. CSS 픽셀 단위이며, 단위 없는 정수 값을 지정해야 합니다.
- : `usemap`
