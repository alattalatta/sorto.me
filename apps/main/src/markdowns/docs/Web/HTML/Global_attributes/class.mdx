...
HTML **`class`** [전역 특성](../Global_attributes)은 요소의 "클래스"를 지정하는 공백 구분 목록입니다. 요소 클래스를 사용하면 CSS [클래스 선택자](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors)와 JavaScript의 [`document.getElementsByClassName()`](https://developer.mozilla.org/en-US/docs/Web/API/Document/getElementsByClassName) 등의 함수로 특정한 요소를 구별해 접근할 수 있습니다.
