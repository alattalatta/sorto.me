    ...
    case 'deprecated':
      return (
        <Abbr css={css} title="표준 명세에서 폐기. 더 이상 사용하지 않는 것이 좋습니다.">
          <SVG aria-label="폐기" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ...
    case 'experimental':
      return (
        <Abbr css={css} title="실험적 기능. 동작이 바뀔 수 있습니다.">
          <SVG aria-label="실험적" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
