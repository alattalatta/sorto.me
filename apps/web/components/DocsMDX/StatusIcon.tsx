...
export const StatusIcon: React.VFC<{ status: 'deprecated' | 'experimental' | 'nonStandard' }> = ({ status }) => {
  switch (status) {
    case 'deprecated':
      return (
        <Abbr title="표준 명세에서 폐기. 더 이상 사용하지 않는 것이 좋습니다.">
    ...
    case 'experimental':
      return (
        <Abbr title="실험적 기능. 동작이 바뀔 수 있습니다.">
    ...
    case 'nonStandard':
      return (
        <Abbr title="표준 기능이 아님. 브라우저 지원이 미흡할 수 있습니다.">
...
export const Deprecated: React.VFC = () => {
  return <StatusIcon status="deprecated" />
}

export const Experimental: React.VFC = () => {
  return <StatusIcon status="experimental" />
}

export const NonStandard: React.VFC = () => {
  return <StatusIcon status="nonStandard" />
}
