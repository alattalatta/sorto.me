...
export const StatusIcon: React.VFC<{ css?: StyleSheet; status: 'deprecated' | 'experimental' | 'nonStandard' }> = ({
  css,
  status,
}) => {
  switch (status) {
    case 'deprecated':
      return (
        <Abbr css={css} title="표준 명세에서 폐기. 더 이상 사용하지 않는 것이 좋습니다.">
          <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-label="폐기" role="img">
    ...
    case 'experimental':
      return (
        <Abbr css={css} title="실험적 기능. 동작이 바뀔 수 있습니다.">
          <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-label="실험적" role="img">
    ...
    case 'nonStandard':
      return (
        <Abbr css={css} title="표준 기능이 아님. 크로스 브라우저 지원이 미흡할 수 있습니다.">
          <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-label="비표준" role="img">
...
export const DeprecatedInline: React.VFC = () => {
  return <StatusIcon css={{ color: '$accentR' }} status="deprecated" />
}

export const ExperimentalInline: React.VFC = () => {
  return <StatusIcon css={{ color: '#0066CF' }} status="experimental" />
}

export const NonStandardInline: React.VFC = () => {
  return <StatusIcon css={{ color: '#333' }} status="nonStandard" />
}
