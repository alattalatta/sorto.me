...
export const StatusIcon: React.VFC<{ className?: string; status: 'deprecated' | 'experimental' | 'nonStandard' }> = ({
  className,
  status,
}) => {
  switch (status) {
    case 'deprecated':
      return (
        <abbr
          className={clsx(styles.iconTooltip, className)}
          title="표준 명세에서 폐기. 더 이상 사용하지 않는 것이 좋습니다."
        >
          <svg
    ...
    case 'experimental':
      return (
        <abbr className={clsx(styles.iconTooltip, className)} title="실험적 기능. 동작이 바뀔 수 있습니다.">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={styles.svg}
            viewBox="0 0 100 100"
    ...
    case 'nonStandard':
      return (
        <abbr
          className={clsx(styles.iconTooltip, className)}
          title="표준 기능이 아님. 크로스 브라우저 지원이 미흡할 수 있습니다."
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={styles.svg}
...
export const DeprecatedInline: React.VFC = () => {
  return <StatusIcon className={styles.deprecated} status="deprecated" />
}

export const ExperimentalInline: React.VFC = () => {
  return <StatusIcon className={styles.experimental} status="experimental" />
}

export const NonStandardInline: React.VFC = () => {
  return <StatusIcon className={styles.nonStandard} status="nonStandard" />
}
