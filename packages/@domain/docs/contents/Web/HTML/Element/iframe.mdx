...
`<iframe>`은 [대체 요소](https://developer.mozilla.org/ko/docs/Web/CSS/Replaced_element)로, CSS [`object-position`](/docs/Web/CSS/object-position)과 [`object-fit`](/docs/Web/CSS/object-fit) 속성을 사용해 삽입한 문서의 위치와 정렬, 크기를 조절할 수 있습니다.
