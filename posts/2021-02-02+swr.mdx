...
<Callout.Root
  childAs="blockquote"
  label={
    <Callout.Cite href="https://twitter.com/kentcdodds/status/1228727040238473216?s=20">@Kent C. Dodds</Callout.Cite>
  }
>
  <p>
...
<Callout.Root
  childAs="blockquote"
  label={
    <Callout.Cite href="https://twitter.com/sebmarkbage/status/1228758860644544514?s=20">
      @Sebastian Markbåge
    </Callout.Cite>
  }
>
...
<Callout.Root childAs="blockquote" label={<Callout.Cite href="https://swr.vercel.app/">SWR 공식 문서</Callout.Cite>}>
